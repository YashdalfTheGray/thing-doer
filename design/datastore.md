...
This collection contains all of the logs that the system and the nodes generate. This includes, but is not limited to logs generated by the nodes while processing a job, errors encountered while processing a job, and logs generated while a node goes through state changes and initialization cycles.
